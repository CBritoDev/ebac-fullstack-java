import br.com.carlosbrito.NomeGeneroLeitor;
import br.com.carlosbrito.Pessoa;
...
public class Main {
    public static void main(String[] args) {
        ...
        testaApenasMulheres(mulheres);

    }

    public static void testaApenasMulheres(List<Pessoa> lista){
        lista.forEach(pessoa -> pessoa.getGenero().equalsIgnoreCase("feminino"));
    }
}